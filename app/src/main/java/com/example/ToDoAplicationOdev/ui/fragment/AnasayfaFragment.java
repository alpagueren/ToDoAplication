...
import com.example.ToDoAplicationOdev.ui.adapter.NotlarAdapter;
...
public class AnasayfaFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.setAnasayfaToolbarBaslik("Notlar");
        ...
        viewModel.notlarListesi.observe(getViewLifecycleOwner(),notlarListesi -> {
            NotlarAdapter adapter = new NotlarAdapter(requireContext(),notlarListesi,viewModel);
    ...
    public void fabTikla(View view){
        Navigation.findNavController(view).navigate(R.id.notKayitGecis);
    }
